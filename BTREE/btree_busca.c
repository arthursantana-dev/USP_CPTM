 ...
 */
int btree_buscar_recursivo(FILE *arquivo, int RRN_atual, int chave_busca)
{
    ...
    return btree_buscar_recursivo(arquivo, no.filhos[i], chave_busca);
}
...
int btree_buscar(FILE *arquivo, header_btree *cabecalho, int chave_busca)
{
    ...
    return btree_buscar_recursivo(arquivo, cabecalho->no_raiz, chave_busca);
}
